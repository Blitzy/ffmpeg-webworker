...
!function(e,t){t(exports);}(commonjsGlobal,function(e){e.default=function e(t){if(function(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}(this,e),"function"!=typeof t)throw new Error("File content must export a function");var n=t.toString(),o=new Blob(["("+n+")()"],{type:"application/javascript"});return new Worker(URL.createObjectURL(o))},Object.defineProperty(e,"__esModule",{value:!0});});

});

var WorkerFile = unwrapExports(dist);
...
var FFMPEGWebworkerClient = /*#__PURE__*/function (_EventEmitter) {
  ...
  function FFMPEGWebworkerClient(ffmpegPath) {
    var _this;
    ...
    _defineProperty(_assertThisInitialized(_this), "ffmpegPath", "https://raw.githack.com/Girilloid/ffmpeg/master/ffmpeg-all-codecs.js");
    /**
...
var FFMPEGWebworker = workerFile;
var FFMPEGWebworkerClient$1 = FFMPEGWebworkerClient;

export { FFMPEGWebworker, FFMPEGWebworkerClient$1 as FFMPEGWebworkerClient };
